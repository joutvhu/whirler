...
module.exports = {
    ...
    MIDDLEWARE_FUNCTION: 'Middleware must be a sync function.',
    OVERRIDE_CLASS: 'You can\'t override the CLASSNAME class.',
    PROPERTY_NAME_CONTAIN: 'The property name can only contain letters (a-z, A-Z), numbers (0-9) or underscore (_).',
    ...
    SPECIFY_PROPERTY_NAME: 'Must specify a property name.',
    START_CLASS_NAME: 'The class name must start with a letter (a-z, A-Z).',
    START_FUNCTION_NAME: 'The function name must start with a lowercase letter (a-z).',
    START_PROPERTY_NAME: 'The property name must start with a lowercase letter (a-z) or underscore (_).',
    SURE_WHIRLER: 'Please make sure each item is Whirler.',
    BUNDLE_NO_WHIRLER: 'The BUNDLENAME bundle does not contain any Whirler.',
    WHIRLES_INVALID: 'The whirles of BUNDLENAME bundle is invalid.'
};
