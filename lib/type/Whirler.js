...
class WhirlerCore {
    constructor() {
        ClassType.preventInheritingClass(this, WhirlerCore, [Whirler, WhirlerBundle]);
...
class WhirlerBundle extends WhirlerCore {
    constructor() {
        ...
        if (this.__whirles.constructor === {}.constructor) {
            ...
            if (e) throw new FormattedError(StringType.replacePlaceholders(ExceptionMessages.BUNDLE_NO_WHIRLER, {
                BUNDLENAME: this.constructor.name
            }));
        } else throw new FormattedError(StringType.replacePlaceholders(ExceptionMessages.WHIRLES_INVALID, {
            BUNDLENAME: this.constructor.name
        }));
    }
