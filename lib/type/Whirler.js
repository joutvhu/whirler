...
const {ClassType, ObjectType, FunctionType} = require('extension-props');
...
class WhirlerBundle extends WhirlerCore {
    constructor() {
        ...
        if(this.__whirles.constructor === {}.constructor) {
            ...
            if(e) throw new Error('The ' + this.constructor.name + ' bundle does not contain any Whirler.');
        } throw new Error('The whirles of ' + this.constructor.name + ' bundle is invalid.');
    }
